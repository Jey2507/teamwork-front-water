...
export default function AddWaterBtn({ mainColor, backgroundColorIcon, colorText, colorIcon }) {
  return (
    <div className={css.wrapper} style={{ backgroundColor: mainColor }}>
      <button className={css.add_water_btn} style={{ color: colorText }}>
        <span className={css.btn_wrapper}>
          <span className={css.circle_btn} style={{ backgroundColor: backgroundColorIcon }}>
